...
// Fundo animado de "holofotes de estádio" atrás do hero da home.
// Adaptado de https://reactbits.dev/backgrounds/light-rays (licença MIT),
// usando `ogl` (WebGL leve, ~30kb) em vez de three.js.
