...
- [x] Adicionar análise de jogadores (em andamento — gols/assistências/cartões reais já no ar, backfill histórico completo ainda rodando aos poucos por causa da cota diária da API)
